					...
					<div class="heading"><h3>用户资料</h3><br></div>
						<div class="form-group">
							...
							<div class="form-group row">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" value="${settingUser.uTel }"  name="uTel" id="uTel" required >
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-2">
										...
										<div class="modal-body">
											<div class="avatar-body">
												...
												<div class="row avatar-btns">
													<div class="col-md-3">
														<button class="btn btn-success btn-block avatar-save" type="submit" onclick="flushPho()"><i class="fa fa-save"></i> 保存修改</button>
													</div>
												</div>
											</div>
										</div>
