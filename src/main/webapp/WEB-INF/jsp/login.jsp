...
<script src="${pageContext.request.contextPath}/frontResource/bootstrap/js/bootstrap.min.js" charset="utf-8"></script>


<script type="text/javascript" src="${pageContext.request.contextPath}/frontResource/JS/User/loginAjax.js" charset="utf-8"></script>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="heading"><h2>登录</h2></div>
						...
						<div class="form-group">
							<input type="text" class="form-control" placeholder="验证码" onkeydown="suball(event)" name="VerificationCode" id="VerificationCode"
								   required >
						</div>
						<div class="row">
				...
				<div class="col-md-6">
					<div class="heading"><h2>新用户？创建一个账号</h2></div>
						...
						<div class="form-group">
							<input name="uGender" id="umGender" type="radio" value="男" checked="checked"> 男
