									...
									<div class="am-article-hd">
										<p class="am-article-meta">
											<a style="color:#999999" target="_blank"
											   v-bind:href=" '${pageContext.request.contextPath}/user/' + question.qMadeByUserId">
												<img :src=" '/tomcat-userPho/'+question.qMadeByUser.smPho"
													 class="img-rounded" alt="头像" style="width: 25px ; height: 25px">
												{{question.qMadeByUser.uName}}

												<%--<br>
												{{question.qMadeByUser.uEmail}}--%>
											</a>
											&nbsp;提出了问题：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   {{ new Date(question.qMadeDate).toLocaleString() }}
										</p>
									</div>
									<div class="am-article-hd">
										<h2>
											<a :href="'${pageContext.request.contextPath}/Question/' + question.qId " style="font-size: 15px">
											{{question.qTitle}}
											</a>
										</h2>
									</div>
