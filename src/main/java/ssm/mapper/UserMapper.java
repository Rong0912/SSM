...
//1.User表
	...
	//更新头像
	int updatePhoto(@Param("uId") Integer uId, @Param("smPho")String smPho);
    //根据email查询出是否被封号
    int queryIsLockByEmail(@Param("uEmail") String uEmail);
    //修改封号
    int updateIsLock(@Param("isLock") Integer isLock,@Param("uId") Integer uId);
	//根据uEmail查询加密后的密码
